...
| grok-build/Grok 4.6 fan-out shows many failed subagents, repeats completed tools, stalls without tokens, or reports live-run 409/429 conflicts | Update to ≥0.1.55 and restart serve. Overflow no longer waits 4 minutes for a generation slot; a full gate also cuts heartbeat-only thinking to 30s. Start a fresh Grok session after upgrading. |
