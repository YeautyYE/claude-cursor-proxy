...
| ~8 min 502 `error decoding response body` | Update to ≥0.1.37 and restart serve. Clash/Surge TUN: DIRECT `*.cursor.sh`. HTTP proxy mode: `CCP_CURSOR_NO_PROXY=1`. Optional: `CCP_CURSOR_HTTP1=1` |
