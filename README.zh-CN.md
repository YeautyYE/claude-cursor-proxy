...
| 约 8 分钟后 502 `error decoding response body` | 升级到 ≥0.1.36 并重启 serve。Clash/Surge TUN 把 `*.cursor.sh` 设为 DIRECT；HTTP 代理模式可设 `CCP_CURSOR_NO_PROXY=1`；仍断可试 `CCP_CURSOR_HTTP1=1` |
